        ...
        <>
            ...
            <div className="container mx-auto mt-8">
                            ...
                            <tbody>
                                {cart.cartItems.map((item, index) => (
                                    <tr key={index} >
                                        ...
                                        <td className="p-2">
                                            <Link to={`/product/${item.product}`}>{item.name.split(' ').splice(0, 5).join(' ')}</Link>
                                        </td>
                ...
                <div className="mt-8">
                    ...
                    <button type="button"
                        className="max-w-[20vw] bg-pink-500 text-white py-2 px-4 rounded-full text-lg w-full mt-4"
