            ...
            <div className='container mx-auto'>
                <div className='flex md:flex-row'>
                    <div className='bg-[#151515] p-3 mt-2 mb-2'>
                        ...
                        <h2 className=" text-center py-2 bg-black rounded-full mb-2">Filter by Brands</h2>
                                ...
                                <>
                                    <div className='flex items-center mr-4 mb-5'>
                                        ...
                                        <label htmlFor='pink-radio'
                                            className='ml-2 text-sm font-medium text-white dark:text-gray-300'>{brand}</label>
                                    </div>
                                </>
                            ))}
                        </div>
